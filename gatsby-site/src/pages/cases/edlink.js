                    ...
                    <div className="row">
                        <div className="col-12 offset-0 col-sm-12 offset-sm-0 col-md-10 offset-md-1">
                            <div className="intro">
                                ...
                                <Tags
                                    tags={["Web design", "Animation", "Front-end development", "Back-end development"]}/>
                                <p className="paragraph">
                                    A system where 'all things come together'. EdLink is a customer data platform that
                                    can
                                    ...
                                    suggesting which duplicate customers can be combined into a single customer, keeping
                                    an
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        ...
                                        <p className="paragraph">
                                            ...
                                            is a
                                            great challenge to give users of the system an idea of the system status at
                                            a
                                            glance, for a system that can display so much relevant information. The top
                                            5
                                            columns of the dashboard provide a quick overview of the system status.
                                            After
                                            having used the system for a short while, users should quickly learn where
                                            to
                            ...
                            <div className="case-details full-width">
                                <div className="row">
                                    <div className="col-12">
                                        ...
                                        <p className="paragraph">
                                            When linking multiple customer management systems, there will always be
                                            duplicates. EdLink automatically recognizes duplicate metadata of customers,
                                            and
                                            allows the administrator of the system to merge this metadata together. The
                                            intuitive interface displayed below emphasizes the differences between the
                                            two
                                            found files. After selecting the correct fields the data can be merged,
                                            previewing
                                            the resulting metadata before executing.
                                        </p>
                                    </div>
                                </div>
                                <div className="row wide-bar color-edlink">
                            ...
                            <div className="case-details full-width">
                                <div className="row">
                                    <div className="col-12">
                                        ...
                                        <p className="paragraph">
                                            EdLink allows for advanced filtering of the available data. By creating
                                            custom
                                            filters, any desired set of customers can be found. This is great for data
                                            management, but even greater for market targeting. A specific set of
                                            customers
                                            could be suited for a lead; these customers can be send a
                                            message suggesting them if the car dealer can be of help to them.
                                        </p>
                                    </div>
                                </div>
                                <div className="row wide-bar color-edlink">
