                        ...
                        <div className="case-details full-width">
                            <div className="row">
                                <div className="col-12">
                                    ...
                                    <p className="paragraph">
                                        The range of functionalities make the EdLink system extremely powerful. It is a
                                        great challenge to give users of the system an idea of the system status at a
                                        glance, for a system that can display so much relevant information. The top 5
                                        columns of the dashboard provide a quick overview of the system status. After
                                        having used the system for a short while, users should quickly learn where to
                            ...
                            <div className="row">
                                <div className="col-12">
                                    ...
                                    <p className="paragraph">
                                        ...
                                        duplicates. EdLink automatically recognizes duplicate metadata of customers, and
                                        allows the administrator of the system to merge this metadata together. The
                                        intuitive interface displayed below emphasizes the differences between the two
                        ...
                        <div className="case-details full-width">
                            <div className="row">
                                <div className="col-12">
                                    ...
                                    <p className="paragraph">
                                        EdLink allows for advanced filtering of the available data. By creating custom
                                        filters, any desired set of customers can be found. This is great for data
                                        management, but even greater for market targeting. A specific set of customers
