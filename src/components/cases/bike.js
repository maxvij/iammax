          ...
          <div className="row">
            <div className="col-12 col-md-6 order-2 order-md-1">
              ...
              <p className="paragraph">
                Similar to the rowing machines from WaterRower, the German
                company{" "}
                <a
                  href="https://www.nohrd.com/"
                  target="_blank"
                  rel="noreferrer"
                  title="NOHrD.com"
                >
                ...
                designs unique fitness devices using high-quality materials. To
                extend the cycling experience with digital possibilities, their
                indoor cycling device, the NOHrD Bike, allows for mounting of a
            ...
            <div className="col-12 col-md-6 order-1 order-md-2">
              <div className="iphone-panel nohrd-bike">
                <img
                  src={Bike}
                  title="Screenshot from the NOHrD Bike app."
