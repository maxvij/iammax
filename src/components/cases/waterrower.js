          ...
          <div className="row">
            ...
            <div className="col-12 col-md-6">
              ...
              <p className="paragraph">
                The stylish rowing machines from{" "}
                <a
                  href="https://www.waterrower.com/"
                  target="_blank"
                  rel="noreferrer"
                  title="WaterRower.com"
                >
                  WaterRower
                </a>{" "}
                provide their customers with a unique experience. To further
                improve this experience, the WaterRower monitor can be connected
                to the WaterRower Connect app, turning a smartphone/tablet into
                a real-time performance monitor. For this project, I designed
                the WaterRower Connect application for phone, tablet (iOS and
